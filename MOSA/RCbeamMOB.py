...
#------------------------------------------------------------------------------
    ...
    def constructability(self):
        ...
        self.min_space_between_rebar= 50        #max(self.nominal_size_aggregate, max(self.rebar_size)) + 5 
        self.min_space_between_stirrups= 50            #70 
        ...
        for i in ast:
            if i <800:
                self.max_bars.append(6)             # max bar is 6
    ...
    def __objCalculation(self):
        ...
        self.design_result= pd.DataFrame({"Weight": total_weight, "Volume": total_volume, "Cost": total_cost, "CO2": total_CO2, "Solution": f"{b},{d}", "Conc Vol": net_conc_vol, "Rebar Vol": rebar_vol, "Stirrup Vol": shearbar_vol, "Rebar Weight": rebar_weight, "Stirrup Weight": shearbar_weight}, index= [1]  )
